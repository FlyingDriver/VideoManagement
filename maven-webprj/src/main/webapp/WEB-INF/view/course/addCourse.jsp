...
<html>
  ...
  <h3>添加课程-课程管理</h3>
  	...
  	<form class="form-horizontal" action="${pageContext.servletContext.contextPath}/admin/addCourse.action" method="post">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label"><strong>课程标题</strong></label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" placeholder="请输入课程标题" name="courseName">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
    	<textarea class="form-control" rows="3" id="inputPassword3" placeholder="请输入课程简介" name="courseDescr"></textarea>
    </div>
  </div>
  <div class="form-group">
